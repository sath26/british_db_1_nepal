...
CREATE TABLE Dim_Project(
	project_sid	INTEGER NOT NULL,
	project_id	INTEGER NOT NULL,
	pit_short_description	DATE,
	pit_required_start_date	DATE,
	pit_estimated_end_date	DATE,
	pit_actual_start_date	DATE,
	pit_renewal_no	INTEGER,
	pit_to_permanent	VARCHAR(8),
	...
	CONSTRAINT	pk_Dim_Project PRIMARY KEY (project_sid)
);

-- Create a Database table to represent the "Dim_Account" entity.
CREATE TABLE Dim_Account(
	account_sid	INTEGER NOT NULL,
	...
	-- This indicates which attribute(s) uniquely identify each row of data.
	CONSTRAINT	pk_Dim_Account PRIMARY KEY (account_sid)
);
...
CREATE TABLE Fact(
	...
	project_fkproject_sid	INTEGER NOT NULL,
	consultant_fkconsultant_sid	INTEGER NOT NULL,
	account_fkaccount_sid	INTEGER NOT NULL,
...
CREATE TABLE Dim_Consultant(
	consultant_sid	INTEGER NOT NULL,
	...
	-- This indicates which attribute(s) uniquely identify each row of data.
	CONSTRAINT	pk_Dim_Consultant PRIMARY KEY (consultant_sid)
);
...
ALTER TABLE Fact ADD CONSTRAINT fk1_Fact_to_Dim_Project FOREIGN KEY(project_fkproject_sid) REFERENCES Dim_Project(project_sid) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE Fact ADD CONSTRAINT fk2_Fact_to_Dim_Consultant FOREIGN KEY(consultant_fkconsultant_sid) REFERENCES Dim_Consultant(consultant_sid) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE Fact ADD CONSTRAINT fk3_Fact_to_Dim_Account FOREIGN KEY(account_fkaccount_sid) REFERENCES Dim_Account(account_sid) ON DELETE RESTRICT ON UPDATE RESTRICT;
